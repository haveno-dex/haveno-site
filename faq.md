...
Our documentation can be found in the [main user-friendly docs](https://docs.haveno.exchange), and [in our GitHub repository](https://github.com/haveno-dex/haveno/tree/master/docs) for techinical details. It contains protocol details, contributing guides, installation instructions, and more.
...
Haveno supports payment methods that don't require users to have a bank account, like ["Cash in person" (for face to face trades (F2F))](https://docs.haveno.exchange/the-project/payment_methods/F2F) and ["Cash by mail"](https://docs.haveno.exchange/the-project/payment_methods/Pay_By_Mail/).
