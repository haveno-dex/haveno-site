...
We finalized [our trade protocol](https://docs.haveno.exchange/the-project/trade-protocol/) (PR: [#107](https://github.com/haveno-dex/haveno/pull/107)) and we are in the process of implementing it in the code. To make this possible, we added some functionalities to monero-wallet-rpc (freeze and thaw outputs).
...
Would you like to contribute to Haveno in exchange for XMR but can't because there is nothing that suits you yet? Just contact us and let us know what would you like to work on. If we think it's worth it, we will gladly add a bounty for the job. See the [conditions for receiving a bounty](https://docs.haveno.exchange/development/bounties/) for more information.
